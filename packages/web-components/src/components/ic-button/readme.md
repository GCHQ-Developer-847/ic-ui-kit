...
| `disableTooltip`   | `disable-tooltip`   | <span style="color:red">**[DEPRECATED]**</span> No longer functional, by default tooltips do not appear on buttons. Use tooltipLabel to add a tooltip.<br/><br/>                                   | `boolean`                                                                                                                                                                                | `false`     |
...
| `tooltipLabel`     | `tooltip-label`     | The text label of the tooltip, which should contain additional content for buttons that have a short label (or aria-label for icon buttons). If not provided the button will not render a tooltip. | `string`                                                                                                                                                                                 | `undefined` |
