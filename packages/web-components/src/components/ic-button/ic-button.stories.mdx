...
<Canvas>
  <Story name="With Tooltip">
    {html`<ic-button
        variant="icon"
        aria-label="refresh"
        tooltip-label="refresh the current page"
        id="testbutton"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <ic-button
        variant="primary"
        id="testbutton2"
        tooltip-label="Submitting the form will refresh the page"
        >Submit</ic-button
      >
      <ic-button
        variant="primary"
        ...
        tooltip-label="This will open a guidance panel if you're struggling to operate the tool"
        >Help</ic-button
      > `}
  </Story>
</Canvas>
